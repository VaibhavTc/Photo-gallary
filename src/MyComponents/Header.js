...
function Header({setImages}) {
    ...
    return (
        <>
            ...
            <button onClick={upload} className='upload-button'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-upload" viewBox="0 0 16 16">
